...
package com.release.muvisdk.player.chromecast;
...
public class CastOptionsProvider implements OptionsProvider {
    ...
    public CastOptions getCastOptions(Context context) {
        ...
        if(ChromeCastApplicationId.chromeCastID!=null && !ChromeCastApplicationId.chromeCastID.equals("")){
            ...
            return new CastOptions.Builder()
                    .setReceiverApplicationId("49A4D3B2")
                    .setCastMediaOptions(mediaOptions)
                    .build();
        }
